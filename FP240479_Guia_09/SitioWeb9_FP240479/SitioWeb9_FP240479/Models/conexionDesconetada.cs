...
namespace SitioWeb9_FP240479.Models
{
    public class conexionDesconetada
    {
        ...
        public conexionDesconetada()
        {
            ...
            DataAdapterEspecífico.SelectCommand =
            new SqlCommand("SELECT * FROM Products", conexionSQL);
        }
        ...
        string UnitPrice, string UnitsInStock, string UnitsOnOrder)
        {
            ...
            try
            {
                ...
                if (DataSetPrincipal.HasChanges())
                {
                    ...
                    new SqlCommandBuilder(DataAdapterEspecífico);
                    int filasAfectadas =
                    DataAdapterEspecífico.Update(DataSetPrincipal, "Products");
