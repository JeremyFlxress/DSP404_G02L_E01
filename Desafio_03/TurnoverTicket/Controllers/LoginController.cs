...
namespace TurnoverTicket.Controllers
{
    public class LoginController : Controller
    {
        ...
        public ActionResult Cliente(string correo, string password)
        {
            ...
            ViewBag.Error = "Correo o contraseña incorrectos, por favor regístrate.";
            return View();
        }
        ...
        public ActionResult Empleado(string correo, string password)
        {
            ...
            if (empleado != null)
            {
                // Almacena el ID del empleado en la sesión
                Session["IDEmpleado"] = empleado.IDEmpleado;

                // Redirige a ListaConciertos si el empleado es válido.
